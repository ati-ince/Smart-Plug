...
void Xbee_API_mod_kullanim()
{
// NOT : 0x90 paketi 15+RF packet+1 olmaktadýr, 0x10 paketi ise  17+RF packet+1 olmaktadýr.....................
// GELEN (0x90) => [0x7E] [Length_High(1)] [Length_Low(1)] [Frame Type(1->0x90)]                     [Addres_Source_Unique_64(8)] [Addres_Source_Network_16(2)]             [Receive_Options(1)] [Received_RF_data(n)] [checksum(1)]
// GIDEN (0x10) => [0x7E] [Length_High(1)] [Length_Low(1)] [Frame Type(1->0x10)] [Frame ID (1-> 01)] [Addres_Source_Unique_64(8)] [Addres_Source_Network_16(2)] [Radius(1)] [Sending_Options(1)] [Sending _RF_data(n)] [checksum(1)]
   unsigned char data_0x90_frame[50]={0}, i_0x90, data_0x90_length, data_0x90_SourceAddr64[8],data_0x90_SourceAddr16[2],data_0x90_ReceivedOptions,data_0x90_RFpacket_location,data_0x90_RFpacket_type,data_0x90_RFpacket_length;  
       
       // Gelen data frameyi kendi buffer array'mize cektik
        for (i_0x90=0;i_0x90<i;i_0x90++){data_0x90_frame[i_0x90]=uart_1_alinan[i_0x90];}
   data_0x90_length=pow(2,8)*data_0x90_frame[1] + data_0x90_frame[2]; 
        
        // Source 64 bit ve 16 bit adreslerin tutulmasý
        for (i_0x90=0;i_0x90<8;i_0x90++){data_0x90_SourceAddr64[i_0x90]=data_0x90_frame[4+i_0x90];}
        for (i_0x90=0;i_0x90<2;i_0x90++){data_0x90_SourceAddr16[i_0x90]=data_0x90_frame[12+i_0x90];}
        
   // RF pakettten gelen framenin türlerinin ayklanmasý ve ayrýþtýrýlmasý felan bu kýsýmda yer alan degiþken yardýmý ile olacaktýr (data_0x90_RFpacket_type)!!!!    
   data_0x90_ReceivedOptions=data_0x90_frame[14];
   data_0x90_RFpacket_location=15; // degiþken uzunluga sahip olmasý sebebi ile, RF paketin baslangic adresi frame uzerinde
   data_0x90_RFpacket_type=data_0x90_frame[15];// Burada isteðin 0x11, 0x22 etc... kararýný verecegiz.
   data_0x90_RFpacket_length=i-16;// uzunluðunu bilmemiz yeterli olur muhtemelen         
            
        if (data_0x90_frame[3] == 0x90) // o zaman 0x10 ile frame olusturup cevap verelim yada doðrudan cevap verelim...
        {
        //&&(checksum_API_corrected(checksum_API_mode())==1)) // -> correect transmission........(coming packet 0x10)
        //alým tamam kontrolu yapalým, OK verisi gonderelim O.K. -> 4 byte
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////
            /*GONDERME-SENDING KISMI*/                 
            unsigned char Send_0x10_Frame[50]={0};//Basilacak frame bu canlar!!!!!!!!!!!!!!!!
            
            ///// baslangýc için bazý degerler ile basladýk ///////////////////////////
            unsigned char data_0x10_length,data_0x10_length_low=0x00,data_0x10_length_high=0x00;
            
            // diziyi doduralim
            Send_0x10_Frame[0]=0x7E;
            Send_0x10_Frame[1]=data_0x10_length_high;Send_0x10_Frame[2]=data_0x10_length_low;
            // NOT , 0x10 dizi uzunluðu bitleri daha sonra gonderilmeden once dogru deeðrlerine cekildi, buradakiler eskileri þimdilik
            // Data sonra gonderilecek RF paketi belli olduktan sonra olmasý gereken degerlere cekilmekteler......
            Send_0x10_Frame[3]=0x10;Send_0x10_Frame[4]=0x01;
                      
            ///// 0x10 Send paketi icin adrei girelm (destination)
            unsigned char data_0x10_SourceAddr64[8],data_0x10_SourceAddr16[2];
               for (i_0x90=0;i_0x90<8;i_0x90++){data_0x10_SourceAddr64[i_0x90]=data_0x90_SourceAddr64[i_0x90];}
               for (i_0x90=0;i_0x90<2;i_0x90++){data_0x10_SourceAddr16[i_0x90]=data_0x90_SourceAddr16[i_0x90];}
                      
            // diziyi doduralim                      
               for (i_0x90=0;i_0x90<8;i_0x90++){Send_0x10_Frame[5+i_0x90]=data_0x90_SourceAddr64[i_0x90];}
               for (i_0x90=0;i_0x90<2;i_0x90++){Send_0x10_Frame[13+i_0x90]=data_0x90_SourceAddr16[i_0x90];}
            Send_0x10_Frame[15]=0x00;//radius
            Send_0x10_Frame[16]=0x00;//options 
            ////
            ////Buraya kadarki kisim her datada ayni olacak malummmm.....
            ////
            /*************************************************************************************************/
            /*************************************************************************************************/
            /*************************************************************************************************/                       
            // Bu Kisimda ise artýk Smart Plug frame kullanabiliriz case yapýsý ile ayýracagiz iþlemleri
            // switch-case yapýsýna sokmadan evvel oncelikle RF paketi ayrý frame haline sokalým
            unsigned char SmartPlugComingFrame[10]={0},SmartPlugSendingFrame[10]={0},SmartPlugComingFrameLength,SmartPlugSendingFrameLength ;//max. 10 elemanlý dizi iþimizi gormekte ve atamasýný yapalým
               for (i_0x90=0;i_0x90<data_0x90_RFpacket_length;i_0x90++){SmartPlugComingFrame[i_0x90]=data_0x90_frame[data_0x90_RFpacket_location+i_0x90];}  
            // Burada içteki paket ortaya çýkmýþ oldu böylelikle...
            /*************************************************************************************************/
            unsigned char SmartPlugComingFrame_PacketType,SmartPlugComingFrame_Hour,SmartPlugComingFrame_Minute, SmartPlugComingFrame_Second;
            SmartPlugComingFrameLength=i_0x90;
            SmartPlugComingFrame_PacketType=SmartPlugComingFrame[0];SmartPlugComingFrame_Hour=SmartPlugComingFrame[1];SmartPlugComingFrame_Minute=SmartPlugComingFrame[2];SmartPlugComingFrame_Second=SmartPlugComingFrame[3];

                 // NOT: RF gonderilecek paketin 0x10 formatýnda baþlýngýç konumu Send_0x10_Frame[17] olup bir uzunluga sahiptir....
                // Ortak kullanýlacak degiþkenleri girelim
                /***************************************************************/
                float32 return_double_value,value;
                unsigned char Vrms_high,Vrms_low,Irms_high,Irms_low;
                /***************************************************************/
                SmartPlugSendingFrameLength=0;
                 switch( SmartPlugComingFrame_PacketType) // Burada 0x11 , 0x22 etc. karar verilmekte
                    {                           
                          case 0x11:
                                Read_Vrms();
                                return_double_value=calculation_24bits(16777215,0.6,378);
                                ...
                                Vrms_low=(unsigned char) value;
                                ///////////////////////////////////////////////////////
                                SmartPlugSendingFrame[0]=0x11;
                                SmartPlugSendingFrame[1]=SmartPlugComingFrame_Hour;
                                SmartPlugSendingFrame[2]=SmartPlugComingFrame_Minute;
                                SmartPlugSendingFrame[3]=SmartPlugComingFrame_Second;
                                SmartPlugSendingFrame[4]=Vrms_high;
                                SmartPlugSendingFrame[5]=0x2E;
                                SmartPlugSendingFrame[6]=Vrms_low;
                                /////
                                SmartPlugSendingFrameLength=1+3+2+1;
                                break;
                        ...
                        case 0x22:
                                ...
                                Irms_low=(unsigned char) value;
                                ///////////////////////////////////////////////////////
                                SmartPlugSendingFrame[0]=0x22;
                                SmartPlugSendingFrame[1]=SmartPlugComingFrame_Hour;
                                SmartPlugSendingFrame[2]=SmartPlugComingFrame_Minute;
                                SmartPlugSendingFrame[3]=SmartPlugComingFrame_Second;
                                SmartPlugSendingFrame[4]=Irms_high;
                                SmartPlugSendingFrame[5]=0x2E;
                                SmartPlugSendingFrame[6]=Irms_low;
                                ///////////////////////////////////////////////////////
                                SmartPlugSendingFrameLength=1+3+2+1;
                                break;
                        ...
                        case 0x33:
                               // Burada öncelikle Dogrudan Pavr olcumu yapacagiz   
                               unsigned int Pavr_Total;
                               unsigned char Pavr_256_Low,Pavr_256_High,Pavr_After_Comma;
                               Read_Pavg();
                               return_double_value=calculation_24bits(8388607,0.36,775);// Bunu katsayý bolgelerine ayýracagýz......
                               value=return_double_value;
                               //
                               ...
                               Pavr_256_High=( (unsigned char) ((Pavr_Total-Pavr_256_Low)/256) );
                               ///////////////////////////////////////////////////////
                               SmartPlugSendingFrame[0]=0x33;
                               SmartPlugSendingFrame[1]=SmartPlugComingFrame_Hour;
                               SmartPlugSendingFrame[2]=SmartPlugComingFrame_Minute;
                               SmartPlugSendingFrame[3]=SmartPlugComingFrame_Second;
                               SmartPlugSendingFrame[4]=Pavr_256_High;
                               SmartPlugSendingFrame[5]=Pavr_256_Low;
                               SmartPlugSendingFrame[6]=0x2E;//virgul koyalim araya;
                               SmartPlugSendingFrame[7]=Pavr_After_Comma;
                               ///////////////////////////////////////////////////////
                               /**************************************/
                               // ama 5 olsun => bin,yuz,on,bir ve .nokta ///////////
                               /**************************************/
                               SmartPlugSendingFrameLength=1+3+(3+1);
                               break;
                               
                        case 0xBB://cirrusa deger yazdýrmak
                               putc(SmartPlugComingFrame[4],UART_2);
                               putc(SmartPlugComingFrame[5],UART_2);
                               putc(SmartPlugComingFrame[6],UART_2);
                               putc(SmartPlugComingFrame[7],UART_2);
                               putc(SmartPlugComingFrame[8],UART_2);
                               break;
                               
                        case 0xCC:
                               
                               /**************************************/
                               Dizi_Temizleme();//Muttemelen bunu yapmam gerekiyordu..
                               /**************************************/
                               ...
                               SmartPlugSendingFrame[3]=SmartPlugComingFrame_Second;
                               //
                               SmartPlugSendingFrame[4]=uart_2_alinan[0];//cirrus register degerleri
                               SmartPlugSendingFrame[5]=uart_2_alinan[1];
                               SmartPlugSendingFrame[6]=uart_2_alinan[2];
                               //////
                               SmartPlugSendingFrameLength=1+3+3;
                               break;
                        ...
                        case 0xEE:
                               switch (SmartPlugComingFrame[4]) //ilk byte frame number sonraki 3 byte zaman sonraki byte'a göre karar verilmesi için bir sw-case yapýsý daha oluþturuldu
                                {                     
                                   case 0x01: //röleye açma komutu gönderilmesi isteniyor, Kullanilan picde b4 pini role cektirmek icin ayarlandý bu pini toogle ederek role ac/kapa yapabiliyoruz            
                                        output_high(pin_b4);
                                        relay_state=1;
                               ...
                               SmartPlugSendingFrame[0]=0xEE;
                               SmartPlugSendingFrame[1]=SmartPlugComingFrame_Hour;
                               SmartPlugSendingFrame[2]=SmartPlugComingFrame_Minute;
                               SmartPlugSendingFrame[3]=SmartPlugComingFrame_Second;
                               //
                               SmartPlugSendingFrame[4]=relay_state;//cirrus register degerleri
                               
                               //////
                               SmartPlugSendingFrameLength=1+3+1;
                               break;  
             ...
             /*************/
             //EKLEME, uzunluk............
            data_0x10_length= 14 + SmartPlugSendingFrameLength;// 16 + SENDÝNG rf YANÝ
            data_0x10_length_low= data_0x10_length % 256 ;
            data_0x10_length_high= (data_0x10_length - data_0x10_length_low)/256 ;
            Send_0x10_Frame[1]=data_0x10_length_high;Send_0x10_Frame[2]=data_0x10_length_low;
            // Bundan sonra SmartPlugSendingFrame[] ve SmartPlugSendingFrameLength hazýr olmuþtur. Dolayýsý ile gonderebiliriz.
            // elbette asýl Send_0x10_Frame[]' e ekledikten sonra.....
            // NOT: RF gonderilecek paketin 0x10 formatýnda baþlýngýç konumu Send_0x10_Frame[17] olup bir uzunluga sahiptir...
               for (i_0x90=0;i_0x90<SmartPlugSendingFrameLength;i_0x90++){Send_0x10_Frame[17+i_0x90]=SmartPlugSendingFrame[i_0x90];}  
               
            /************************************************************************************************/
            // Son olarak checksum olusturup gondereceðiz.....
            unsigned int checksum=0;
               for (i_0x90=0;i_0x90<(14+SmartPlugSendingFrameLength);i_0x90++){checksum=checksum+Send_0x10_Frame[3+i_0x90];}
            Send_0x10_Frame[16+SmartPlugSendingFrameLength+1]=(unsigned char) (255-(checksum%256)) ;//checksum, 
            // burada [17+rf paket.] nci matris indisli ama 18+rf packetinci eleman aslýnda
            ///////
            ////////////////////////////////////////////////////////////////////
            // NOT: i_0x10 tanimlanmasýna ihtiyac duyulmaktadýr.... Cunkü gelen-giden frame birbirinden farklý oldugu gibi, her bir gonderilen pakette birbirlerinden farklý olabilmektedirler....
            // DATAYI UARTTAN 0x10 FORMATI ILE GONDER
                for (i_0x90=0;i_0x90<(18+SmartPlugSendingFrameLength);i_0x90++){ putc(Send_0x10_Frame[i_0x90],UART_1);}//Burada datayý basýyoruz....
        }   
}
